...
const Checkout = () => {
  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      fullName: Yup.string()
        .min(5, 'O nome precisater ter pelo menos 5 caracteres')
      ...
      cpf: Yup.string()
        ...
        .max(15, 'O CPF deve ter 14 dígitos')
        .required('O CPF é obrigatório'),
      deliveryEmail: Yup.string()
        .email('E-mail inválido')
        .required('O e-mail de entrega é obrigatório'),
      confirmDeliveryEmail: Yup.string().oneOf([Yup.ref('deliveryEmail')], 'Os e-mails não conferem').required('A confirmação do e-mail de entrega é obrigatória'),
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={form.handleSubmit}>
        ...
        <Button type="button" tittle="Clique aqui para finalizar a compra" onClick={form.handleSubmit}>
          Finalizar compra
        </Button>
      </form>
      )}
